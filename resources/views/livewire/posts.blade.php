<div>
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 mt-5">
        ...
        <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            <h1 class="text-center font-bold text-lg">DATA PRODUCT</h1>
            <button wire:click="showModal()" class="bg-green-500 hover:bg-green-200 text-white font-bold py-1 px-4 rounded mb-2">
                Create
            </button>
                 @if ($isOpen)
